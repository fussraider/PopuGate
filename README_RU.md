...
- **Пакетное добавление**: Проверка и импорт множества прокси одновременно через пошаговый мастер с автоопределением протокола, живым запросом выходного IP, фильтрацией по пингу и пакетной транзакционной вставкой в базу данных.
